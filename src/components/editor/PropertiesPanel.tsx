...
export const PropertiesPanel: React.FC = () => {
  ...
  if (!selectedClipId || !selectedClip) {
    return (
      <div className="w-64 bg-surface border-l border-border flex flex-col p-4 overflow-y-auto scrollbar-thin">
  ...
  return (
    <div className="w-64 bg-surface border-l border-border flex flex-col overflow-y-auto scrollbar-thin">
          ...
          <div className="space-y-2">
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-surface-raised border border-border rounded px-2 py-1 text-xs text-text-primary"
                />
              </div>
              <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <input
                  type="number"
                  value={Math.round(selectedClip.width)}
              ...
              <div>
                ...
                <input
                  type="number"
                  value={Math.round(selectedClip.height)}
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  type="number"
                  value={Math.round(selectedClip.rotation)}
                  onChange={(e) => handleUpdate('rotation', Number(e.target.value))}
                  className="w-12 bg-surface-raised border border-border rounded px-2 py-1 text-xs text-text-primary"
                />
              </div>
            </div>
          ...
          <div className="space-y-2">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleUpdate('trimIn', Number(e.target.value))}
                className="w-full bg-surface-raised border border-border rounded px-2 py-1 text-xs text-text-primary"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleUpdate('trimOut', Number(e.target.value))}
                className="w-full bg-surface-raised border border-border rounded px-2 py-1 text-xs text-text-primary"
              />
            </div>
          </div>
